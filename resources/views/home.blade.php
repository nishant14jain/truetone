...
<div class='page-content homePage'>
			...
			<div class='row'>
				...
				<div class='col-md-6 col-lg-6 col-sm-12 col-xs-12'>
					<div class='desc-wrapper text-left'>
						...
						<a href='{{ url('dyes') }}' class="true-btn">
			...
			<div class='row'>
				<div class='col-md-6 col-lg-6 col-sm-12 col-xs-12'>
					<div class='desc-wrapper text-left'>
						...
						<a href='{{ url('yarns') }}' class="true-btn">
							<span class="pull-left">Learn more</span>
							<span class="pull-right"><i class="material-icons"></i></span>
							<div class="clearfix"></div>
						</a>
			...
			<div class='row'>
				...
				<div class='col-md-6 col-lg-6 col-sm-12 col-xs-12'>
					<div class='desc-wrapper text-left'>
						...
						<a href='{{ url('fabrics') }}' class="true-btn">
							<span class="pull-left">Learn more</span>
							<span class="pull-right"><i class="material-icons"></i></span>
							<div class="clearfix"></div>
						</a>
	...
	<section class='featuring hidden'>
		<div class="strip dye">
			<div class='overlay'>
				<h1>Dyes</h1>
				<p>Herbal Dyes are made with the love of nature and goodness of Auyrvedic herbs. Truetone Inc. brings you the technology of industrial level dyes with the ancient art of natural dyeing at its core. Save our Seas with these dyes that have only nutrient rich effluent.</p>
	...
	<section class='ourprocess'>
		...
		<section class='infographic'>
			<div class='container'>
				...
				<img  src='{{asset('images/Infographic-02.svg')}}' />
			</div>
		</section>
				...
				<div class='row'>
					...
					<div class='col-md-6 col-lg-6 col-sm-6 col-xs-12'>
						<div class='desc-wrapper text-left'>
							...
							<p>
								Join us in our endeavor to change the face of industrial dyes. Let your consumers know that you subscribe to the natural way of dyeing. Using our dyes, yarns or fabrics in your design will make you eligible to tag your product with the Truetone Stamp. Be proud of you make!
							</p>
							<a href='#!' class='true-btn'>
